...
export function FavIcon({
  width, height, fill, outlineWidth, stroke, displayAlert, setDisplayAlert, setFill
}) {
    const updateFav = () => {
  ...
  return (
    <svg onClick={()=>{updateFav()}} width={width} height={height} viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
